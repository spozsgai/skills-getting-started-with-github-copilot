...
activities = {
    ...
    "Soccer Club": {
        "description": "Teamwork and drills with weekend matches",
    ...
    "Art Studio": {
        ...
        "max_participants": 16,
        "participants": ["lily@mergington.edu", "lucas@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Science Olympiad": {
        "description": "Hands-on experiments and competition preparation",
